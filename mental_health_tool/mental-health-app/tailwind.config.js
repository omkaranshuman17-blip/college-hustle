...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // MindSpace Design System Colors
        slate: {
          50: '#F8FAFC',
          100: '#F1F5F9',
          200: '#E2E8F0',
      ...
      fontFamily: {
        'sans': ['Inter', 'Segoe UI', 'Roboto', 'system-ui', 'sans-serif'], // Clean body text
        'display': ['Sora', 'Plus Jakarta Sans', 'system-ui', 'sans-serif'], // Display font
        'body': ['Inter', 'Segoe UI', 'system-ui', 'sans-serif'], // Readable body text
        'heading': ['Plus Jakarta Sans', 'Segoe UI Variable', 'Inter', 'system-ui', 'sans-serif'], // Modern headings
        'mono': ['JetBrains Mono', 'Consolas', 'Monaco', 'monospace'],
        'quabble': ['Nunito', 'Poppins', 'system-ui', 'sans-serif'], // Keep for backward compatibility
        // New design system fonts
        'jakarta': ['Plus Jakarta Sans', 'Segoe UI Variable', 'Inter', 'system-ui', 'sans-serif'],
      ...
      animation: {
        ...
        'slideUp': 'slideUp 300ms cubic-bezier(0.2, 0.8, 0.2, 1)',
        'scaleIn': 'scaleIn 200ms cubic-bezier(0.2, 0.8, 0.2, 1)',
        'breathingGlow': 'breathingGlow 6s cubic-bezier(0.4, 0, 0.6, 1) infinite',
      },
      keyframes: {
        float: {
        ...
        breathe: {
          '0%, 100%': { 
            boxShadow: '0 0 0 0 rgba(42, 179, 169, 0.2)'
          },
          '50%': { 
            boxShadow: '0 0 0 12px rgba(42, 179, 169, 0)'
          }
        },
        fadeIn: {
          from: { opacity: '0' },
        ...
        breathingGlow: {
          '0%, 100%': {
            boxShadow: '0 0 0 0 rgba(42, 179, 169, 0.4)'
          },
          '50%': {
            boxShadow: '0 0 20px 10px rgba(42, 179, 169, 0)'
          }
        }
      },
      spacing: {
